...
class stuff_me_cocktail
{
     ...
     * @var string
     *
     * @ORM\Column(name="coktail_image", type="string", length=255)
     */
    private $coktailImage;
     ...
     * Set coktailImage
     *
     * @param string $coktailImage
     *
     * @return stuff_me_cocktail
     */
    public function setCoktailImage($coktailImage)
    {
        $this->coktailImage = $coktailImage;
     ...
     * @return string
     */
    public function getCoktailImage()
    {
        return $this->coktailImage;
    }
}
