...
(function($) {
	"use strict";
		...
		$('#clock-countdown').countdown('2017/04/01 00:00:00').on('update.countdown', function(event) {
			var $this = $(this).html(event.strftime(''
				+ '<div class="counter-container"><div class="counter-box first"><div class="number">%-D</div><span>Jour%!d</span></div>'
				+ '<div class="counter-box"><div class="number">%H</div><span>Heures</span></div>'
				+ '<div class="counter-box"><div class="number">%M</div><span>Minutes</span></div>'
				+ '<div class="counter-box last"><div class="number">%S</div><span>Secondes</span></div></div>'
			));
		});
